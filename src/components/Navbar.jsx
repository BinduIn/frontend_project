		...
		return (
			<>
					...
					<Link
						...
						className={`flex items-center justify-center gap-2 rounded-md px-2 py-1 text-white hover:bg-gray-500 ${
							window.location.pathname === '/cinema'
								? 'bg-gradient-to-br from-indigo-800 to-pink-700'
								: 'bg-gray-600'
						}`}
					>
				...
				<div className="flex grow items-center justify-center gap-3 lg:justify-end">
					...
					{auth.token ? (
						<button
							className="rounded-lg bg-gradient-to-br from-indigo-600 to-pink-500 px-2 py-1 text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400"
							onClick={() => onLogout()}
						...
						<button className="rounded-lg bg-gradient-to-br from-indigo-600 to-pink-500 px-2 py-1 text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-400">
