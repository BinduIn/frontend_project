...
const TheaterListsByCinema = ({ cinemas, selectedCinemaIndex, setSelectedCinemaIndex, fetchCinemas, auth }) => {
	...
	return (
		<div className="mx-4 h-fit rounded-md bg-gradient-to-br from-indigo-200 to-pink-100 text-gray-900 drop-shadow-md sm:mx-8">
						...
						{isEditing ? (
							<form onClick={handleSubmitName(onEditCinema)}>
								<button
									...
									className="flex w-fit items-center gap-1 rounded-md bg-gradient-to-r from-indigo-600 to-pink-500  py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-indigo-500 hover:to-pink-400"
									onClick={() => {
										SetIsEditing(false)
									}}
								>
							...
							<button
								...
								className="flex w-fit items-center gap-1 rounded-md bg-gradient-to-r from-indigo-600 to-pink-500  py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-indigo-500 hover:to-blue-400"
							...
							<div className="flex grow flex-col gap-4 sm:justify-end md:flex-row">
								...
								<div className="flex grow md:grow-0">
									...
									<button
										...
										className="flex grow items-center justify-center whitespace-nowrap rounded-r bg-gradient-to-r from-indigo-600 to-pink-500 px-2 py-1 font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400 md:grow-0"
										type="submit"
									>
