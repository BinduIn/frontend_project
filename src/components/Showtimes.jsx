											...
											<button
												...
												className={
													isPast(new Date(showtime.showtime))
														...
														? 'flex items-center gap-1 rounded-md bg-gradient-to-br from-indigo-600 to-pink-500 px-2 py-1 text-lg text-white drop-shadow-sm hover:from-indigo-500 hover:to-pink-400'
