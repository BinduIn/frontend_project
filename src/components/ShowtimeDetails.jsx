	...
	return (
		<>
				...
				<div className="mb-4 flex justify-end gap-2">
					{!showtime.isRelease && (
						<button
							...
							className="flex w-fit items-center gap-1 rounded-md bg-gradient-to-r from-indigo-600 to-pink-500  py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-indigo-500 hover:to-pink-400 disabled:from-slate-500 disabled:to-slate-400"
			...
			<div className="flex justify-between">
				...
				<div className="flex w-fit grow items-center justify-center rounded-tr-lg bg-gradient-to-br from-indigo-800 to-pink-700 px-4 py-0.5 text-center text-xl font-bold text-white sm:text-3xl">
