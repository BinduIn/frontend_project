...
const DateSelector = ({ selectedDate, setSelectedDate }) => {
		...
		return (
			<button
				...
				className={`flex min-w-[48px] flex-col items-center justify-center rounded p-1 font-semibold ${
					isThisDate
						? 'bg-gradient-to-br from-indigo-800 to-pink-700 text-white'
						: isToday
						? 'bg-gradient-to-br from-indigo-100 to-white ring-2 ring-inset ring-indigo-500 hover:from-white hover:to-white'
						: isPast(date)
	...
	return (
		<div className="flex flex-col gap-2">
			<div className="relative flex items-stretch justify-between gap-2 rounded-md bg-gradient-to-br from-indigo-800 to-pink-700 p-2 font-semibold text-white">
				{auth.role === 'admin' || !isPast(new Date().setDate(selectedDate.getDate() - 1)) ? (
					<button
						title="Go to yesterday"
						className={'rounded hover:bg-gradient-to-br hover:from-indigo-600 hover:to-pink-600'}
				...
				{isEditing ? (
					<div className="w-full" ref={wrapperRef}>
						<input
							...
							required
							autoFocus
							className={`w-full rounded border border-white bg-gradient-to-br from-indigo-800 to-pink-700 px-1 text-center text-2xl font-semibold drop-shadow-sm sm:text-3xl`}
					...
					<div
						className="flex w-full items-center justify-center rounded text-center text-xl hover:bg-gradient-to-br hover:from-indigo-600 hover:to-pink-600 sm:text-2xl"
						onClick={() => {
							SetIsEditing(true)
						}}
					>
				...
				<div className="flex items-center justify-between gap-2">
					<button
						...
						className="rounded hover:bg-gradient-to-br hover:from-indigo-600 hover:to-pink-500"
					...
					<button
						title="Go to today"
						className="rounded px-1 hover:bg-gradient-to-br hover:from-indigo-600 hover:to-pink-500"
						onClick={handleToday}
					>
