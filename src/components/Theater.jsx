	...
	return (
		<div className="flex flex-col">
			<div className="flex md:justify-between">
				...
				{auth.role === 'admin' && (
					<div className="flex w-fit flex-col gap-x-3 rounded-tr-2xl bg-gradient-to-br from-indigo-800 to-pink-700 px-4 py-0.5 font-semibold text-white md:flex-row md:gap-x-6 md:rounded-t-2xl md:text-lg md:font-bold">
					...
					<>
						...
						>
							...
							<button
								...
								className="whitespace-nowrap rounded-md bg-gradient-to-r from-indigo-600 to-pink-500 px-2 py-1 font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400"
								type="submit"
							>
								ADD +
							</button>
						...
						{filterMovie?.name && (
							<div className="mx-4 flex gap-2 rounded-md bg-gradient-to-r from-indigo-600 to-pink-500 p-2 text-white">
