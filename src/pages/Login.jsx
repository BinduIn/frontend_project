...
const Login = () => {
	...
	return (
		<div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-900 to-pink-500 py-12 px-4 sm:px-6 lg:px-8">
			<div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-4 shadow-xl">
				...
				<form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)}>
					...
					<div>
						...
						<button
							type="submit"
							className="mt-4 w-full rounded-md bg-pink-500 bg-gradient-to-br from-indigo-600 to-pink-500 py-2 px-4 font-medium text-white drop-shadow-md hover:bg-blue-700 hover:from-indigo-500 hover:to-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:from-slate-500 disabled:to-slate-400"
					...
					<p className="text-right">
						...
						<Link to={'/register'} className="font-bold text-pink-600">
							Register here
						</Link>
					</p>
				</form>
