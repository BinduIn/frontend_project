			...
			<div className="mx-4 flex h-fit flex-col gap-4 rounded-md bg-gradient-to-br from-indigo-200 to-blue-100 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				...
				>
					...
					<div className="flex w-full flex-col gap-4 lg:w-auto lg:flex-row">
						...
						<button
							className="w-full min-w-fit items-center rounded-md bg-gradient-to-br from-indigo-600 to-pink-500 px-2 py-1 text-center font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-pink-500 disabled:from-slate-500 disabled:to-slate-400 lg:w-24 xl:w-32 xl:text-xl"
							type="submit"
