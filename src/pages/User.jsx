							...
							return (
								<Fragment key={index}>
									...
									<div className="border-t-2 border-indigo-200 px-2 py-1">
										...
										${
											ticketsUser === user.username
												? 'from-indigo-600 to-pink-500 hover:from-indigo-500 hover:to-pink-400'
									...
									<div className="flex gap-2 border-t-2 border-indigo-200 px-2 py-1">
										{user.role === 'user' && (
											<button
												className="flex w-[115px] items-center justify-center gap-1 rounded bg-gradient-to-r from-indigo-600 to-pink-500 py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-indigo-500 hover:to-pink-400 disabled:from-slate-500 disabled:to-slate-400"
