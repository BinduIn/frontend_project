...
const Schedule = () => {
	...
	return (
		<div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-indigo-900 via-f6643b to-pink-500 pb-8 sm:gap-8">
			<Navbar />
			<CinemaLists {...props} />
			{selectedCinemaIndex !== null &&
				(cinemas[selectedCinemaIndex]?.theaters?.length ? (
					<div className="mx-4 flex flex-col gap-2 rounded-lg bg-gradient-to-br from-indigo-200 to-pink-100 p-4 drop-shadow-xl sm:mx-8 sm:gap-4 sm:p-6">
						...
						{auth.role === 'admin' && (
							...
							>
								...
								<button
									...
									className="whitespace-nowrap rounded-md bg-gradient-to-r from-indigo-600 to-pink-500 px-2 py-1 font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-pink-400 disabled:from-slate-500 disabled:to-slate-400"
									type="submit"
								>
									ADD +
								</button>
