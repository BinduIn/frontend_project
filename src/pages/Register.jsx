			...
			<div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-4 shadow-xl">
				...
				<form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)}>
					...
					<div>
						...
						<button
							type="submit"
							className="mt-4 w-full rounded-md bg-blue-600 bg-gradient-to-br from-indigo-600 to-pink-500 py-2 px-4 font-medium text-white drop-shadow-md hover:bg-blue-700 hover:from-indigo-500 hover:to-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:from-slate-500 disabled:to-slate-400"
